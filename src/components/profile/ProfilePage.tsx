...
import { User, Mail, Phone, MapPin, Calendar, Shield, Send, QrCode, Check, AlertTriangle, Copy, Download, Share2 } from 'lucide-react';
...
const ProfilePage = () => {
    ...
    const userAvatar = currentUser.avatar || `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(userName)}`;
    const [randomJoinDate] = useState(() => getRandomPastDate(2, 1));
    ...
    const [showConfigureEmailDialog, setShowConfigureEmailDialog] = useState(false);
    const [showConfigureSMSDialog, setShowConfigureSMSDialog] = useState(false);
    const [showConfigureAppNotificationsDialog, setShowConfigureAppNotificationsDialog] = useState(false);
    ...
    function getRandomPastDate(yearsBack = 2, minYearsBack = 1) {
        const now = new Date();
        const diff = (Math.random() * (yearsBack - minYearsBack) + minYearsBack) * 365 * 24 * 60 * 60 * 1000;
        const pastTime = now.getTime() - diff;
        return new Date(pastTime).toLocaleDateString();
    }
        ...
        <DashboardLayout userName={userName} userAvatar={userAvatar}>
            <div className="space-y-6 p-4 px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Card className="relative md:col-span-1 bg-card">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center border rounded-md pl-3 bg-muted">
                                                    ...
                                                    <Input id="fullName" defaultValue={profileData.name} className="border-0 bg-transparent" />
                                                </div>
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center border rounded-md pl-3 bg-muted">
                                                    ...
                                                    <Input id="email" type="email" defaultValue={profileData.email} className="border-0 bg-transparent" />
                                                </div>
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center border rounded-md pl-3 bg-muted">
                                                    ...
                                                    <Input id="phone" defaultValue={profileData.phone} className="border-0 bg-transparent" />
                                                </div>
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center border rounded-md pl-3 bg-muted">
                                                    ...
                                                    <Input id="address" defaultValue={profileData.address} className="border-0 bg-transparent" />
                                                </div>
                                            </div>
                                        </div>
                                    </CardContent>
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center p-4 border rounded-lg">
                                                ...
                                                <Button variant="outline" onClick={() => setShowTwoFADialog(true)}>
                                            ...
                                            <div className="flex justify-between items-center p-4 border rounded-lg">
                                                ...
                                                <Button variant="outline" onClick={() => setShowLoginHistoryDialog(true)}>
                                                    View History
                                                </Button>
                                            </div>
                                            <div className="flex justify-between items-center p-4 border rounded-lg">
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center p-4 border rounded-lg">
                                                ...
                                                <Button variant="outline" onClick={() => setShowConfigureEmailDialog(true)}>
                                                    Configure
                                                </Button>
                                            </div>
                                            <div className="flex justify-between items-center p-4 border rounded-lg">
                                                ...
                                                <Button variant="outline" onClick={() => setShowConfigureSMSDialog(true)}>
                                                    Configure
                                                </Button>
                                            </div>
                                            <div className="flex justify-between items-center p-4 border rounded-lg">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">Control push notifications on your devices</p>
                                                </div>
                                                <Button variant="outline" onClick={() => setShowConfigureAppNotificationsDialog(true)}>
                                                    Configure
                                                </Button>
                                            </div>
                                        </div>
                ...
                <Dialog open={showSendDialog} onOpenChange={setShowSendDialog}>
                    <DialogContent className="sm:max-w-[500px]">
                        ...
                        <DialogFooter>
                            ...
                            <Button onClick={handleSendMoney} disabled={!sendRecipient || !sendAmount}>
                                Send Money
                            </Button>
                        </DialogFooter>
                    </DialogContent>
                    ...
                    <DialogContent className="sm:max-w-[500px]">
                        ...
                        <div className="space-y-4 py-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="editEmail" type="email" defaultValue={profileData.email} />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea id="editBio" placeholder="Tell us a little about yourself" />
                            </div>
                        </div>
                        <DialogFooter>
                ...
                <Dialog open={showLoginHistoryDialog} onOpenChange={setShowLoginHistoryDialog}>
                    <DialogContent className="sm:max-w-[500px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>View your recent login activities.</DialogDescription>
                        </DialogHeader>
                        <div className="py-4">
                            <ul className="list-disc pl-5">
                                <li>{new Date().toLocaleString()} - Successful login from IP 192.168.1.1</li>
                                <li>{new Date().toLocaleString()} - Successful login from IP 192.168.1.2</li>
                            </ul>
                        </div>
                        <DialogFooter>
                            <Button onClick={() => setShowLoginHistoryDialog(false)}>Close</Button>
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
                ...
                <Dialog open={showConfigureEmailDialog} onOpenChange={setShowConfigureEmailDialog}>
                    <DialogContent className="sm:max-w-[500px]">
                        <DialogHeader>
                            <DialogTitle>Email Notifications</DialogTitle>
                            <DialogDescription>Configure your email notification preferences.</DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4 py-4">
                        ...
                        <DialogFooter>
                            <Button variant="outline" onClick={() => setShowConfigureEmailDialog(false)}>
                                Cancel
                            </Button>
                ...
                <Dialog open={showConfigureSMSDialog} onOpenChange={setShowConfigureSMSDialog}>
                    <DialogContent className="sm:max-w-[500px]">
                        <DialogHeader>
                            <DialogTitle>SMS Notifications</DialogTitle>
                            <DialogDescription>Configure your SMS notification preferences.</DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4 py-4">
                            <div className="flex items-center">
                                <Input
                        ...
                        <DialogFooter>
                            <Button variant="outline" onClick={() => setShowConfigureSMSDialog(false)}>
                                Cancel
                            </Button>
                ...
                <Dialog open={showConfigureAppNotificationsDialog} onOpenChange={setShowConfigureAppNotificationsDialog}>
                    <DialogContent className="sm:max-w-[500px]">
                        <DialogHeader>
                            <DialogTitle>App Notifications</DialogTitle>
                            <DialogDescription>Configure your app push notification preferences.</DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4 py-4">
                            <div className="flex items-center">
                                <Input
                        ...
                        <DialogFooter>
                            <Button variant="outline" onClick={() => setShowConfigureAppNotificationsDialog(false)}>
                                Cancel
                            </Button>
